...
// Deprecated: Use WorkSpec.ProtoReflect.Descriptor instead.
...
var file_proto_suddpanzer_proto_goTypes = []any{
	(*WorkSpec)(nil),        // 0: suddpanzer.WorkSpec
	(*MetricsSnapshot)(nil), // 1: suddpanzer.MetricsSnapshot
	(*AgentStatus)(nil),     // 2: suddpanzer.AgentStatus
}
var file_proto_suddpanzer_proto_depIdxs = []int32{
	0, // 0: suddpanzer.SuddpanzerAgent.RunScenario:input_type -> suddpanzer.WorkSpec
	1, // 1: suddpanzer.SuddpanzerAgent.RunScenario:output_type -> suddpanzer.MetricsSnapshot
